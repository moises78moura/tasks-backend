pipeline{
    ...
    post{
        ...
        unsuccessful{
            emailext attachLog: true, body: 'See the attached log!', subject: 'Build $BUILD_NUMBER has failed', to: 'lojaarmazemmarias+jenkins@gmail.com'
        }
        fixed{
            emailext attachLog: true, body: 'See the attached log!', subject: 'Build $BUILD_NUMBER is success!', to: 'lojaarmazemmarias+jenkins@gmail.com'
        }
    }
